...
namespace Tyuiu.PolyakovaAB.Sprint1.Task6.V10
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Написать программу, которая при вводе строки убирает в словах с нечётным*");
            Console.WriteLine("* количеством букв среднюю букву.                                         *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
